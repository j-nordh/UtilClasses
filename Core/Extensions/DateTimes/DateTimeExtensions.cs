...
public static class DateTimeExtensions
{
    ...
    public static bool TryParseUtc(this string? s, out DateTime dt) 
        => DateTime.TryParse(s, null, DateTimeStyles.AssumeUniversal | DateTimeStyles.AdjustToUniversal, out dt);
}