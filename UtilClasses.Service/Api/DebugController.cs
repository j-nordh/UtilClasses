...
public  class DebugController:Controller
{
    ...
    public string PrintRoutes([FromQuery] bool updateFiles = false)
    {
        ...
        {
            var c = endpoint.DisplayName.SubstringAfter("Api.").SubstringBefore(".", out var rest).RemoveAllOic("Controller");
        ...
        var assemblies = endpoints.Select(ep => ep.DisplayName.SubstringAfter("(").SubstringBefore(")")).Distinct()
            ;
        ...
        //    .Where(ep=>ep.DisplayName.ContainsOic(assemblyName))
