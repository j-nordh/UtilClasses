...
namespace UtilClasses.Extensions.Objects
{
    public static class ObjectExtensions
    {
        private static readonly Dictionary<System.Type, Func<IConvertible, object>> _converters;

        static ObjectExtensions()
        {
            _converters = new Dictionary<System.Type, Func<IConvertible, object>>
            {
        ...
        public static T Having<T>(this T obj, Func<T, bool> f) where T : class => f(obj) ? obj : null;
        ...
        public static T ThrowIfNull<T>(this T obj, System.Exception e) => obj.ThrowIfNull(() => e);

        public static T ThrowIfNull<T>(this T obj, string message) =>
            obj.ThrowIfNull(() => new System.Exception(message));
        ...
        public static TOut? WhenNotNull<TIn, TOut>(this TIn? obj, Func<TIn, TOut> f) where TIn : class where TOut : class
            => null == obj ? null : f(obj);
        public static TOut? WhenNotNull<TIn, TOut>(this TIn? obj, Func<TOut> f) where TIn : class where TOut : class
            => null == obj ? null : f();

        public static TOut? WhenNull<TIn, TOut>(this TIn? obj, Func<TOut> fNull, Func<TOut> fNotNull) where TIn : class where TOut : class
            => null == obj ? fNull() : fNotNull();

        public static TOut WhenNull<TIn, TOut>(this TIn obj, Func<TOut> nullFunc, Func<TIn, TOut> notNullFunc) where TIn : class => obj.When(o => null == o, nullFunc, () => notNullFunc(obj));
        ...
        public static TOut When<TIn, TOut>(this TIn obj, Func<TIn, bool> predicate, Func<TOut> onTrue, Func<TOut> onFalse)
        ...
        {
            if (null == a) return obj;
            a(obj);
            return obj;
        }

        public static T If<T>(this T obj, Func<T, bool> predicate, Action<T> onTrue, Action<T> onFalse)
        {
            if (predicate(obj)) onTrue.Invoke(obj);
            else onFalse?.Invoke(obj);
            return obj;
        }

        public static T If<T>(this T obj, bool predicate, Action<T> onTrue) => obj.If(_ => predicate, onTrue, _ => { });
        public static T If<T>(this object obj, Action<T> onTrue, Action onFalse) where T : class
        {
            if (!(obj is T t))
            {
                onFalse();
        ...
        public static Dictionary<string, string> AsDictionary(this object o, StringComparer? comp = null) =>
            ...
            .ToDictionary(p => p.Name, p => p.GetValue(o).ToString(), comp ?? StringComparer.OrdinalIgnoreCase);
    }
}
